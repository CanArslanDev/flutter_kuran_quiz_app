...
const appName = "İslami Bilgi Yarışması";
const packageName = "com.islami.diniyarisma";
...
const initialSelectedCountryCode = 'TR';
...
const databaseUrl = "https://muslim.kuranikerim.app";
...
///
const examRules = [
  "Googledan kopya çekmeyeceğim ve bu sınavı dürüstlükle bitireceğim.",
  "Telefonunuzun ekranı kilitlenirse, o zaman sınav otomatik olarak tamamlanır.",
  "Uygulamayı küçültürseniz veya başka bir uygulamayı açar ve 5 saniye içinde uygulamaya geri dönmezseniz, sınav otomatik olarak tamamlanır.",
  "Ekran kaydı yasaktır.",
  "Android'de ekran görüntüsü almak yasaktır.",
  "iOS'ta ekran görüntüsü alırsanız, kurallar ihlal edilir ve yetkiliye bildirilir."
];
